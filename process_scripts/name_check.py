...
base_content = """
Ты - помощник для сравнения полей с именами. Тебе даны три поля: "FullName(rus)", "FirstName+LastName" и склеенное поле из "FirstName", "SecondName" и "LastName". 
Твоя задача - проверить, совпадают ли эти поля. Ответь "Да", если имена совпадают, и "Нет", если нет.
"""
